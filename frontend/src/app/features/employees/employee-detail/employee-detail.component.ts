...
@Component({
    ...
    template: `
    @if (employee) {
      <div class="min-h-screen bg-[#0f172a] text-slate-200 font-sans selection:bg-indigo-500/30 overflow-x-hidden relative">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                  ...
                  <div class="relative mb-6">
                    <div class="w-40 h-40 rounded-[48px] overflow-hidden border-4 border-white/10 shadow-2xl relative z-10">
                      @if (!employee.avatarUrl) {
                        <div class="w-full h-full bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center text-5xl font-bold text-white">
            ...
            <div class="lg:col-span-8 xl:col-span-9 space-y-8 animate-fade-in" style="animation-delay: 0.2s">
                  ...
                  <div class="glass-container p-8 rounded-[40px] space-y-8 col-span-1 md:col-span-2 lg:col-span-1">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-6">
                      ...
                      <div class="space-y-1">
                        ...
                        @if (employee.manager) {
                          <p class="font-semibold text-indigo-400 cursor-pointer hover:underline">
              ...
              @if (activeTab === 'documents') {
                <div class="glass-container p-8 rounded-[40px] space-y-8 animate-slide-up">
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
                    ...
                    @if (!loadingDocuments && documents.length === 0) {
                      <div class="col-span-full py-20 text-center glass-panel rounded-[32px] border-dashed border-2 border-white/10">
                    ...
                    @for (doc of documents; track doc) {
                      <div class="group glass-panel p-6 rounded-[32px] border border-white/10 hover:bg-white/5 transition-all relative overflow-hidden">
                  ...
                  <div class="glass-container p-8 rounded-[40px] overflow-hidden">
                    ...
                    <div class="overflow-x-auto">
                      <table class="w-full text-left">
                        ...
                        <tbody>
                          @for (record of attendanceSummary?.records; track record) {
              ...
              @if (activeTab === 'history' || activeTab === 'leaves' || activeTab === 'performance') {
                <div class="glass-container p-20 rounded-[40px] text-center">
                  ...
                  @if (selectedFile) {
                    <div class="flex flex-col items-center gap-4">
                      <div class="w-20 h-20 rounded-[28px] overflow-hidden bg-white/5 border border-white/10 p-2">
                        @if (filePreviewUrl) {
                          <img [src]="filePreviewUrl" class="w-full h-full object-cover rounded-2xl">
                        }
                        @if (!filePreviewUrl) {
                          <lucide-icon [name]="getFileIcon()" size="32" class="text-indigo-400 mx-auto mt-4"></lucide-icon>
                        }
                      </div>
                      <div>
    ...
    @if (!employee && loading) {
      <div class="fixed inset-0 flex items-center justify-center bg-[#0f172a] z-[200]">
        <div class="relative">
