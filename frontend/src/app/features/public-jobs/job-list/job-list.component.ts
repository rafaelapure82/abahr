    ...
    <div class="min-h-screen bg-muted/30 pb-12">
      ...
      <div class="max-w-5xl mx-auto px-6 -mt-10">
        ...
        <div class="grid gap-6">
           ...
           <div *ngIf="!loading && jobs.length === 0" class="text-center p-20 bg-card rounded-2xl border border-dashed border-border">
           ...
           <div *ngFor="let job of jobs" class="group bg-card hover:bg-muted/10 border border-border hover:border-primary/30 rounded-2xl p-6 transition-all shadow-sm hover:shadow-md flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div class="flex flex-col gap-2">
                 <div class="flex items-center gap-3">
                    ...
                    <span *ngIf="job.isRemote" class="text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded bg-blue-500/10 text-blue-600">
                       Remoto
                    </span>
                 </div>
                 ...
                 <div class="flex flex-wrap gap-4 mt-2">
                    ...
                    <span *ngIf="job.salaryMin" class="text-sm text-muted-foreground flex items-center gap-1.5">
