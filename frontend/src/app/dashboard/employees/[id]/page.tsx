  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 pb-20 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {activeTab === 'GENERAL' && (
          <>
            <div className="lg:col-span-2 space-y-8">
              ...
              <Section icon={<User />} title="Datos Personales">
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <InfoItem label="Teléfono" value={employee.personalPhone} />
                  ...
                  <div className="col-span-2"><InfoItem label="Dirección" value={employee.addressLine1} /></div>
                </div>
              </Section>

              {/* Bank Info Section */}
              <Section icon={<CreditCard className="text-amber-500" />} title="Información Bancaria (Nómina)">
                <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-8">
              ...
              {/* Work Details */}
              <Section icon={<Briefcase className="text-primary" />} title="Relación Laboral">
                <div className="space-y-4">
        ...
        {activeTab === 'HISTORY' && (
          <div className="lg:col-span-3 card-premium bg-white p-8 space-y-6">
            <h3 className="font-black text-xs uppercase tracking-widest text-slate-400 border-b border-slate-50 pb-4">Historial de Auditoría</h3>
            <div className="space-y-4">
              {history.length === 0 ? (
